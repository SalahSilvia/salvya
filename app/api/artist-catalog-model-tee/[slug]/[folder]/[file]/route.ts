...
import { resolveArtistCatalogModelTshirtFilePath } from "@/lib/artist-folder-model-shots";
...
export async function GET(
  ...
  const filePath = resolveArtistCatalogModelTshirtFilePath(slug, folder, file);
